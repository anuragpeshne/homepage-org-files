...
#+DATE: 2020-05-12
#+OPTIONS: toc:nil num:t creator:t author:t tex:t
...
* Arrival
  ...
  haven't left the house except for groceries since early March. And just when one
...
** Detection
   ...
   I wondered if I slept that night exposing both hands and feet, would the insects
...
** TODO Know your Enemy
   Bed bugs are neural network with reward function linked to human blood equipped
   with:
   1. CO₂ sensor - to detect CO₂ released from breathing to locate a human
   2. Pheromone sensor - to follow a path marked by other bugs
   3. and maybe a light sensor - to detect darkness
   I know this is not a complete and mostly an incorrect description of a bed bug.
   But this is good enough for applying our algorithms.

** TODO Washing with Heat
   - can travel [[https://www.epa.gov/bedbugs/how-find-bed-bugs][5-20 feet]]
