...
** Power Consumption
#+CAPTION: Power Consumption using USB power meter.
#+ATTR_HTML: :width 500px
  ...
  - OPNsense gives more control and insights about home network, along with some useful features:
    - ability to create VLANs
      - one use case could to keep trusted devices such as personal computer on
        one network and other devices, such as /smart/ TVs, voice assistants,
